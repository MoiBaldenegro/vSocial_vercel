...
export const twitterProfileCard = (profilePicture: string) => {
    // Hardcodeando la información
    const coverPhoto = 'https://example.com/cover.jpg'; // Hardcodeado
  ...
  <div class="twitter-profile-card-twt">
    ...
    <div class="profile-info-twt">
      ...
      <p class="bio" style="background-color: #f0f0f0; padding: 10px; border-radius: 5px;">${bio}</p>
      <p class="joined">
  ...
  <style>
    ...
    .profile-picture-twt {
      margin-top: -75px;
      z-index: 1; /* Asegura que la foto de perfil esté por encima de la portada */
    }
  
    .profile-picture-twt img {
